...
ALTER TABLE ONLY public.tb_order_item
    ADD CONSTRAINT tb_order_item_pkey PRIMARY KEY (order_id, procuct_id);
...
--
-- Name: tb_order_item fkmndw1xkvm90aw85vgf0yxdh7; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tb_order_item
    ADD CONSTRAINT fkmndw1xkvm90aw85vgf0yxdh7 FOREIGN KEY (procuct_id) REFERENCES public.tb_product(id);
